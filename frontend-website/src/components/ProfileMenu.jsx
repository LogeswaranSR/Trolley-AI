...
const ProfileMenu = ({ states }) => {
	const { var: currentPage, fn: navigateTo } = states["currentPage"];
	const { var: isOpen, fn: setIsOpen } = states["profileMenu"];
    ...
    const menuItems = [
        { icon: <Bell size={20} />, label: "Notifications", count: 3, navigateTo: "settings" },
        { icon: <BookMarked size={20} />, label: "Saved Places", count: 12, navigateTo: "settings" },
        { icon: <History size={20} />, label: "Recent Views", count: 8, navigateTo: "settings" },
        { icon: <Heart size={20} />, label: "Favorites", count: 5, navigateTo: "settings" },
        { icon: <Settings size={20} />, label: "Settings", navigateTo: "settings" }
    ];
